...
INSERT INTO `ventas` VALUES ('1','2023-04-15',1000.00,'PM0001','EM0015',NULL),('10','2024-01-05',850.00,NULL,'EM0015',NULL),('11','2024-02-14',950.00,'PM0007','EM0015',NULL),('12','2024-03-21',2000.00,NULL,'EM0015',NULL),('13','2024-04-30',1250.00,'PM0008','EM0015',NULL),('14','2024-05-16',2600.00,NULL,'EM0015',NULL),('15','2024-06-18',2300.00,'PM0009','EM0015',NULL),('16','2024-07-19',2800.00,'PM0010','EM0015',NULL),('17','2024-08-25',1100.00,NULL,'EM0015',NULL),('18','2024-09-30',3200.00,'PM0011','EM0015',NULL),('19','2024-10-31',2100.00,'PM0012','EM0015',NULL),('2','2023-05-01',2500.00,NULL,'EM0015',NULL),('20','2024-11-20',3000.00,NULL,'EM0015',NULL),('21','2023-04-15',1000.00,'PM0001','EM0008',NULL),('22','2023-12-15',750.00,NULL,'EM0008',NULL),('23','2023-12-15',750.00,NULL,'EM0008',NULL),('24','2023-05-01',2500.00,NULL,'EM0008',NULL),('25','2023-06-10',1200.00,'PM0002','EM0008',NULL),('26','2023-07-05',3000.00,'PM0003','EM0008',NULL),('27','2023-10-20',2200.00,'PM0005','EM0008',NULL),('28','2023-11-28',1900.00,NULL,'EM0008',NULL),('29','2023-12-15',2900.00,'PM0006','EM0008',NULL),('3','2023-06-10',1200.00,'PM0002','EM0008',NULL),('30','2024-01-05',850.00,NULL,'EM0008',NULL),('31','2024-02-14',950.00,'PM0007','EM0008',NULL),('32','2024-03-21',2000.00,NULL,'EM0008',NULL),('33','2024-04-30',1250.00,'PM0008','EM0008',NULL),('34','2024-05-16',2600.00,NULL,'EM0008',NULL),('35','2024-06-18',2300.00,'PM0009','EM0015',NULL),('36','2024-07-19',2800.00,'PM0010','EM0015',NULL),('37','2024-08-25',1100.00,NULL,'EM0008',NULL),('38','2024-09-30',3200.00,'PM0011','EM0008',NULL),('39','2023-08-15',1500.00,NULL,'EM0015',NULL),('4','2023-07-05',3000.00,'PM0003','EM0015',NULL),('40','2023-09-10',750.00,'PM0004','EM0015',NULL),('41','2023-04-15',1000.00,'PM0001','EM0015',NULL),('42','2023-05-01',2500.00,NULL,'EM0015',NULL),('43','2023-06-10',1200.00,'PM0002','EM0015',NULL),('44','2023-05-01',2500.00,NULL,'EM0015',NULL),('45','2023-06-10',1200.00,'PM0002','EM0015',NULL),('46','2023-07-05',2500.00,'PM0003','EM0015',NULL),('47','2023-10-20',2200.00,'PM0005','EM0015',NULL),('48','2023-11-28',2500.00,NULL,'EM0015',NULL),('49','2023-12-15',2900.00,'PM0006','EM0015',NULL),('5','2023-08-15',1500.00,NULL,'EM0015',NULL),('50','2024-01-05',850.00,NULL,'EM0008',NULL),('51','2024-02-14',950.00,'PM0007','EM0008',NULL),('52','2024-03-21',2500.00,NULL,'EM0008',NULL),('53','2025-04-30',1250.00,'PM0008','EM0008',NULL),('54','2025-05-16',2600.00,NULL,'EM0008',NULL),('55','2024-06-18',2300.00,'PM0009','EM0008',NULL),('56','2024-07-19',2500.00,'PM0010','EM0008',NULL),('57','2025-08-25',2500.00,NULL,'EM0008',NULL),('58','2024-09-30',3200.00,'PM0011','EM0008',NULL),('59','2023-08-15',1500.00,NULL,'EM0008',NULL),('6','2023-09-10',750.00,'PM0004','EM0008',NULL),('60','2023-09-10',750.00,'PM0004','EM0008',NULL),('7','2023-10-20',2200.00,'PM0005','EM0008',NULL),('8','2023-11-28',1900.00,NULL,'EM0008',NULL),('9','2023-12-15',2900.00,'PM0006','EM0008',NULL),('VT0001','2024-11-21',100.00,NULL,'EM0008','tarjeta'),('VT0002','2024-11-21',1.00,NULL,'EM0008','tarjeta');
/*!40000 ALTER TABLE `ventas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `vista_atenciones_por_departamento`
--

DROP TABLE IF EXISTS `vista_atenciones_por_departamento`;
/*!50001 DROP VIEW IF EXISTS `vista_atenciones_por_departamento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_atenciones_por_departamento` AS SELECT 
 1 AS `NombreDepartamento`,
 1 AS `NumeroAtenciones`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vista_automoviles_registrados`
--

DROP TABLE IF EXISTS `vista_automoviles_registrados`;
/*!50001 DROP VIEW IF EXISTS `vista_automoviles_registrados`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_automoviles_registrados` AS SELECT 
 1 AS `ID_Automovil`,
 1 AS `Marca`,
 1 AS `Modelo`,
 1 AS `Anio`,
...
--
-- Temporary view structure for view `vista_clientes_automoviles`
--

DROP TABLE IF EXISTS `vista_clientes_automoviles`;
/*!50001 DROP VIEW IF EXISTS `vista_clientes_automoviles`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_clientes_automoviles` AS SELECT 
 1 AS `ID_Cliente`,
 1 AS `NombreCliente`,
 1 AS `ID_Automovil`,
 1 AS `Marca`,
...
--
-- Temporary view structure for view `vista_clientes_solo_diagnostico`
--

DROP TABLE IF EXISTS `vista_clientes_solo_diagnostico`;
/*!50001 DROP VIEW IF EXISTS `vista_clientes_solo_diagnostico`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_clientes_solo_diagnostico` AS SELECT 
 1 AS `ID_Cliente`,
 1 AS `Nombre`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vista_consumo_refacciones`
--

DROP TABLE IF EXISTS `vista_consumo_refacciones`;
/*!50001 DROP VIEW IF EXISTS `vista_consumo_refacciones`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_consumo_refacciones` AS SELECT 
 1 AS `NombreDepartamento`,
 1 AS `Descripcion`,
 1 AS `CantidadConsumida`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `vista_empleados_por_departamento`
--

DROP TABLE IF EXISTS `vista_empleados_por_departamento`;
/*!50001 DROP VIEW IF EXISTS `vista_empleados_por_departamento`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_empleados_por_departamento` AS SELECT 
 1 AS `ID_Empleado`,
 1 AS `Nombre`,
 1 AS `Cargo`,
 1 AS `NombreDepartamento`*/;
...
--
-- Temporary view structure for view `vista_ganancias_taller`
--

DROP TABLE IF EXISTS `vista_ganancias_taller`;
/*!50001 DROP VIEW IF EXISTS `vista_ganancias_taller`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_ganancias_taller` AS SELECT 
 1 AS `Fecha`,
 1 AS `Total`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vista_promocion_mas_aplicada`
--

DROP TABLE IF EXISTS `vista_promocion_mas_aplicada`;
/*!50001 DROP VIEW IF EXISTS `vista_promocion_mas_aplicada`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_promocion_mas_aplicada` AS SELECT 
 1 AS `ID_Promocion`,
 1 AS `Descripcion`,
 1 AS `VecesAplicada`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vista_promociones_vencidas`
--

DROP TABLE IF EXISTS `vista_promociones_vencidas`;
/*!50001 DROP VIEW IF EXISTS `vista_promociones_vencidas`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_promociones_vencidas` AS SELECT 
 1 AS `ID_Promocion`,
 1 AS `Descripcion`,
 1 AS `Fecha_Fin`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vista_promociones_vigentes`
--

DROP TABLE IF EXISTS `vista_promociones_vigentes`;
/*!50001 DROP VIEW IF EXISTS `vista_promociones_vigentes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_promociones_vigentes` AS SELECT 
 1 AS `ID_Promocion`,
 1 AS `Descripcion`,
 1 AS `Descuento`,
 1 AS `Fecha_Inicio`,
...
--
-- Temporary view structure for view `vista_refaccion_mas_vendida`
--

DROP TABLE IF EXISTS `vista_refaccion_mas_vendida`;
/*!50001 DROP VIEW IF EXISTS `vista_refaccion_mas_vendida`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_refaccion_mas_vendida` AS SELECT 
 1 AS `ID_Parte`,
 1 AS `Descripcion`,
...
--
-- Temporary view structure for view `vista_reparaciones_frecuentes`
--

DROP TABLE IF EXISTS `vista_reparaciones_frecuentes`;
/*!50001 DROP VIEW IF EXISTS `vista_reparaciones_frecuentes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_reparaciones_frecuentes` AS SELECT 
 1 AS `ID_Departamento`,
 1 AS `Descripcion`,
 1 AS `Frecuencia`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vista_supervisores_supervisados`
--

DROP TABLE IF EXISTS `vista_supervisores_supervisados`;
/*!50001 DROP VIEW IF EXISTS `vista_supervisores_supervisados`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_supervisores_supervisados` AS SELECT 
 1 AS `ID_Departamento`,
 1 AS `NombreDepartamento`,
 1 AS `Supervisor`,
 1 AS `Supervisado`*/;
...
--
-- Temporary view structure for view `vista_ventas_diagnosticos`
--

DROP TABLE IF EXISTS `vista_ventas_diagnosticos`;
/*!50001 DROP VIEW IF EXISTS `vista_ventas_diagnosticos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_ventas_diagnosticos` AS SELECT 
 1 AS `ID_Venta`,
 1 AS `Fecha`,
 1 AS `Importe`,
 1 AS `Total`*/;
...
--
-- Final view structure for view `vista_atenciones_por_departamento`
--
...
/*!50001 VIEW `vista_atenciones_por_departamento` AS select `d`.`Nombre` AS `NombreDepartamento`,count(`ot`.`ID_Orden_Trabajo`) AS `NumeroAtenciones` from (((`departamento` `d` left join `empleado` `e` on((`d`.`ID_Departamento` = `e`.`ID_Departamento`))) left join `asignacion` `a` on((`e`.`ID_Empleado` = `a`.`ID_Empleado`))) left join `orden_trabajo` `ot` on((`a`.`ID_Orden_Trabajo` = `ot`.`ID_Orden_Trabajo`))) group by `d`.`ID_Departamento`,`d`.`Nombre` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_automoviles_registrados`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_automoviles_registrados` AS select distinct `a`.`ID_Automovil` AS `ID_Automovil`,`a`.`Marca` AS `Marca`,`a`.`Modelo` AS `Modelo`,`a`.`Anio` AS `Anio`,`a`.`Vin` AS `Vin`,`d`.`Fecha` AS `Fecha_Ingreso` from (`automovil` `a` join `diagnostico` `d` on((`a`.`ID_Automovil` = `d`.`ID_Automovil`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_clientes_automoviles`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_clientes_automoviles` AS select `c`.`ID_Cliente` AS `ID_Cliente`,`c`.`Nombre` AS `NombreCliente`,`a`.`ID_Automovil` AS `ID_Automovil`,`a`.`Marca` AS `Marca`,`a`.`Modelo` AS `Modelo`,`a`.`Anio` AS `Anio` from (`cliente` `c` left join `automovil` `a` on((`c`.`ID_Cliente` = `a`.`ID_Cliente`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_clientes_solo_diagnostico`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_clientes_solo_diagnostico` AS select distinct `c`.`ID_Cliente` AS `ID_Cliente`,`c`.`Nombre` AS `Nombre` from ((`cliente` `c` join `diagnostico` `d` on((`c`.`ID_Cliente` = `d`.`ID_Cliente`))) left join `orden_trabajo` `ot` on((`d`.`ID_Orden_Trabajo` = `ot`.`ID_Orden_Trabajo`))) where (`ot`.`ID_Orden_Trabajo` is null) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_consumo_refacciones`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_consumo_refacciones` AS select `d`.`Nombre` AS `NombreDepartamento`,`p`.`Descripcion` AS `Descripcion`,sum(`vp`.`Cantidad`) AS `CantidadConsumida` from ((`departamento` `d` join `parte` `p` on((`d`.`ID_Departamento` = `p`.`ID_Departamento`))) join `venta_parte` `vp` on((`p`.`ID_Parte` = `vp`.`ID_Parte`))) group by `d`.`ID_Departamento`,`d`.`Nombre`,`p`.`ID_Parte`,`p`.`Descripcion` order by `d`.`Nombre`,`CantidadConsumida` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_empleados_por_departamento`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_empleados_por_departamento` AS select `e`.`ID_Empleado` AS `ID_Empleado`,`e`.`Nombre` AS `Nombre`,`e`.`Cargo` AS `Cargo`,`d`.`Nombre` AS `NombreDepartamento` from (`empleado` `e` join `departamento` `d` on((`e`.`ID_Departamento` = `d`.`ID_Departamento`))) order by `d`.`Nombre`,`e`.`Nombre` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_ganancias_taller`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_ganancias_taller` AS select `ventas`.`Fecha` AS `Fecha`,`ventas`.`Total` AS `Total` from `ventas` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_inventario` AS select `parte`.`ID_Parte` AS `ID_Parte`,`parte`.`Descripcion` AS `Descripcion`,`parte`.`Precio_Unitario` AS `Precio_Unitario`,`parte`.`Stock` AS `Stock`,`parte`.`ID_Departamento` AS `ID_Departamento` from `parte` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_promocion_mas_aplicada`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_promocion_mas_aplicada` AS select `p`.`ID_Promocion` AS `ID_Promocion`,`p`.`Descripcion` AS `Descripcion`,count(0) AS `VecesAplicada` from (`promocion` `p` join `ventas` `v` on((`p`.`ID_Promocion` = `v`.`ID_Promocion`))) group by `p`.`ID_Promocion`,`p`.`Descripcion` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_promociones_vencidas`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_promociones_vencidas` AS select `promocion`.`ID_Promocion` AS `ID_Promocion`,`promocion`.`Descripcion` AS `Descripcion`,`promocion`.`Fecha_Fin` AS `Fecha_Fin` from `promocion` where (`promocion`.`Fecha_Fin` < curdate()) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_promociones_vigentes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_promociones_vigentes` AS select `promocion`.`ID_Promocion` AS `ID_Promocion`,`promocion`.`Descripcion` AS `Descripcion`,`promocion`.`Descuento` AS `Descuento`,`promocion`.`Fecha_Inicio` AS `Fecha_Inicio`,`promocion`.`Fecha_Fin` AS `Fecha_Fin` from `promocion` where (`promocion`.`Fecha_Fin` >= curdate()) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_refaccion_mas_vendida`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_refaccion_mas_vendida` AS select `p`.`ID_Parte` AS `ID_Parte`,`p`.`Descripcion` AS `Descripcion`,sum(`vp`.`Cantidad`) AS `CantidadVendida`,sum(`vp`.`Total`) AS `GananciaTotal` from (`parte` `p` join `venta_parte` `vp` on((`p`.`ID_Parte` = `vp`.`ID_Parte`))) where (`p`.`ID_Departamento` = 'DP0005') group by `p`.`ID_Parte`,`p`.`Descripcion` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_reparaciones_frecuentes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_reparaciones_frecuentes` AS select `e`.`ID_Departamento` AS `ID_Departamento`,`s`.`Descripcion` AS `Descripcion`,count(0) AS `Frecuencia` from ((`servicio` `s` join `asignacion` `a` on((`s`.`ID_Servicio` = `a`.`ID_Servicio`))) join `empleado` `e` on((`a`.`ID_Empleado` = `e`.`ID_Empleado`))) group by `e`.`ID_Departamento`,`s`.`ID_Servicio`,`s`.`Descripcion` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_supervisores_supervisados`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_supervisores_supervisados` AS select `d`.`ID_Departamento` AS `ID_Departamento`,`d`.`Nombre` AS `NombreDepartamento`,`e1`.`Nombre` AS `Supervisor`,`e2`.`Nombre` AS `Supervisado` from ((`departamento` `d` join `empleado` `e1` on((`d`.`Supervisor` = `e1`.`ID_Empleado`))) join `empleado` `e2` on((`d`.`ID_Departamento` = `e2`.`ID_Departamento`))) where (`e1`.`ID_Empleado` <> `e2`.`ID_Empleado`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vista_ventas_diagnosticos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_ventas_diagnosticos` AS select `v`.`ID_Venta` AS `ID_Venta`,`v`.`Fecha` AS `Fecha`,`vd`.`Importe` AS `Importe`,`vd`.`Total` AS `Total` from (`ventas` `v` join `venta_diagnostico` `vd` on((`v`.`ID_Venta` = `vd`.`ID_Venta`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-11-21 21:19:01
